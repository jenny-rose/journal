_NOTES TO SELF_ Learn to Code - front-end development. HTML, CSS, Javascript. Part one about HTML & CSS. Basics: learning syntax, vocabulary, the box model. Advanced: styleguides, writing clean code.
